      ...
      <div className="max-w-md w-full space-y-8 animate-fade-in">
        ...
        {!isConfirmed ? (
          ...
          <div className="bg-slate-800 border border-slate-700 p-8 rounded-3xl shadow-2xl text-center">
             ...
             <button
               onClick={onForceOpen}
               className="w-full bg-white text-slate-900 font-black py-4 px-6 rounded-xl mb-6 hover:bg-slate-200 transition-colors shadow-lg shadow-white/10 flex items-center justify-center gap-2"
             >
